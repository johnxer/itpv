                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="contact-details">
                                <li>
                                    <a href="mailto:info@itpventures.com"><i class="fa fa-envelope-o"></i> info@itpventures.com</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
    ...
    <div class="navbar navbar-default navbar-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">ITP <span>Ventures</span><br />
                    <strong>The Intrapreneur Accelerator</strong>
                </a>
            </div>
