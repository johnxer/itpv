...
<body>
    ...
    <div class="page-header page-header-statement">
        <div class="overlay">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
    ...
    <section id="about-section-2" class="about-section">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4>Impact of FinTech</h4>
                    <img src="asset/images/graph_1.jpg" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
    <section class="about-section">
    <a id="vc_model" href="#"></a>
        <div class="container">
            <div class="row">
                <div class="col-md-10">
                    <h4>Enterprise Response: Setting up CVCs</h4>
                    <img src="asset/images/graph_2.jpg" class="img-responsive">
                </div>
            </div>
        </div>
    </section>
